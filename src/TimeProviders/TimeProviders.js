  ...
  ({ children, globalMinimumAccuracy, onIntervalUpdate, onRegistrationsUpdate }) => {
    ...
    return (
      <GlobalMinimumAccuracyContext.Provider value={vaildatedGlobalMinimumAccuracy}>
        <ONE_YEAR.context.Provider value={yearValue}>
          <ONE_MONTH.context.Provider value={monthValue}>
            <ONE_DAY.context.Provider value={dayValue}>
              <ONE_HOUR.context.Provider value={hourValue}>
                <ONE_MINUTE.context.Provider value={minuteValue}>
                  <ONE_SECOND.context.Provider value={secondValue}>
                    {children}
                  </ONE_SECOND.context.Provider>
                </ONE_MINUTE.context.Provider>
